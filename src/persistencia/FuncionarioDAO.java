...
public class FuncionarioDAO implements DAO{
  private Conexao con = new Conexao();
    ...
    private final String INSERIR = "INSERT INTO \"CLIENTE\" (\"CPF\", \"NOME\", \"SEXO\", \"ENDERECO\", \"TELEFONE\", \"SENHA\", \"SALARIO\") VALUES(?,?,?,?,?,?,?)";
    private final String EXCLUIR = "DELETE FROM \"CLIENTE\" WHERE \"CPF\" = ?";
    private final String ALTERAR = "UPDATE \"CLIENTE\" SET \"NOME\"=?, \"SEXO\"=?, \"ENDERECO\"=?, \"TELEFONE\"=?, \"SENHA\"=? \"SALARIO\"=? WHERE \"cpf\"=?";
    ...
    public void alterarFnc(String cpf, String nome, String sexo, String enredeco, String telefone, String senha, double salario) {
        try {
            ...
            instruction.setDouble(6, salario);
            instruction.setString(7, cpf);
            instruction.execute();
            con.desconecta();
        } catch (SQLException e) {
